...
/// <c>RunAsync</c> task: <see cref="DisposeAsync"/> awaits it and lets any fault surface. A discarded
/// task would let a server that throws during teardown leave every concurrency test green.
/// </remarks>
