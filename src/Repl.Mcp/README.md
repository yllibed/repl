...
Repl.Mcp can also expose inline MCP Apps UI resources:
...
Clients with MCP Apps support render the `ui://` resource inline. Other MCP clients still receive the tool's normal text result.
