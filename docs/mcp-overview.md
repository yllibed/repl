...
| `.LongRunning()` | Slow-operation hint (protocol-level task advertisement returns with the SDK Tasks runtime — see [mcp-reference.md](mcp-reference.md#sdk-and-protocol-versions)) |
